...
const sites = [
    ...
    { id: 'eelslapBox', url: 'https://eelslap.com' },
    { id: 'shorttripBox', url: 'https://alexanderperrin.com.au/paper/shorttrip/' },
    { id: 'weavesilkBox', url: 'https://weavesilk.com/' },
    { id: 'zoomquiltBox', url: 'https://zoomquilt.org/' },
    { id: 'donothingBox', url: 'https://www.donothingfor2minutes.com/' },
    ...
    { id: 'twentyBox', url: 'https://twenty.frenchguys.net/' },
    ...
    { id: 'buildshruggieBox', url: 'https://www.buildshruggie.com/' },
    { id: 'patienceBox', url: 'https://www.patience-is-a-virtue.org/' },
    ...
    { id: 'fractaljigsawBox', url: 'https://thatmichaelpark.github.io/fractal-jigsaw-puzzle/fractaljigsaw.html' },
    { id: 'ring4Box', url: 'https://shapesmania.com/rings4n' },
    { id: 'goldrunBox', url: 'https://weirdly.net/webgames/goldRun/' },
    { id: 'grenouilleBox', url: 'https://weirdly.net/webgames/GourmandGrenouille/' },
